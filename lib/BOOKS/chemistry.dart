...
class ChemistryDetailPage extends StatefulWidget {
  final String subjectName;

  ChemistryDetailPage({required this.subjectName});

  @override
  _MathsDetailPageState createState() => _MathsDetailPageState();
}

class _MathsDetailPageState extends State<ChemistryDetailPage>
